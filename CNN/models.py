...
## Baseline Model
# class Baseline2(tf.keras.models.Model):
...
#         inputs = Input(shape=input_shape[1:]) # input_shape[1:] = (height, width, channels)
#         x = self.bn1(inputs)
...
# TODO: fix model class to support keras model saving
